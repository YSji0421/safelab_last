...
export const safetyApi = {
  ...
  getAccidentDistribution: () => api.get('/safety/admin/accidents/distribution'),
  getRecentIncidents: () => api.get('/safety/admin/accidents/recent'),
  getPendingStudents: () => api.get('/safety/admin/pending'),
};
