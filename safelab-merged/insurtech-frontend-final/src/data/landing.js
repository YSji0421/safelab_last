...
export const HERO = {
  ...
  headline: '교육 · 공제 · 대응\n안전, 하나의 플랫폼으로.',
  subcopy:
    '인하공전 안전관리위원회가 우려한 \'학과당 2~3시간 집계 부담\'과 \'8월 차세대 시스템 공백\'을 SafeLab은 오늘 메웁니다. 학과별 시나리오·퀴즈로 안전교육 이수부터 「연구실 안전환경 조성에 관한 법률」 제26조 의무 가입, 사고 발생 시 AI 사진 분석 기반 등급 자동 분류와 보상 청구까지 — 인하공전 「2026 대학안전관리계획」 실제 데이터를 시드로 한 연구실 안전 통합 플랫폼. 학과 담당자 추가 업무는 0건입니다.',
