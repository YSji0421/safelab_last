...
export const HERO = {
  ...
  headline: '교육 · 공제 · 대응\n안전, 하나의 플랫폼으로.',
  subcopy:
    '학과별 시나리오·퀴즈로 안전교육 이수부터 「연구실 안전환경 조성에 관한 법률」 제26조 의무 가입, 사고 발생 시 AI 사진 분석 기반 등급 자동 분류와 보상 청구까지 — 인하공전 「2026 대학안전관리계획」, 「연구실안전공제」 약관, 「실습실 안전관리규정」 실제 데이터를 시드로 한 연구실 안전 통합 플랫폼.',
...
export const LINEUP = {
  ...
  items: [
    ...
    },
    {
      ...
      desc: '연구실안전공제 가입·청구',
      detail: '「연구실 안전환경 조성에 관한 법률」제26조 의무 가입부터 사고 시 보상 청구까지. 요양·장해·유족·입원·장의비 5종 보장 — Gemini AI 약관 분석 상담실 + 가입·청구 폼.',
      icon: 'ShieldCheck',
    ...
    },
    {
      ...
      desc: '학과 담당자 자동 집계 + 사고 즉시 통보',
      detail: '학과당 2~3시간 수기 집계 → 0초 자동화. 미이수자 일괄 알림 + 사고 발생 시 학과 담당자 즉시 통보 + 차세대 행정시스템 호환 export(JSON/CSV).',
      icon: 'Activity',
